 ...
 * @author McCauley - rewrote loops in PecolateDown and insert
 */
...
//    }
    ...
    public AnyType findMin() {
        if (isEmpty())
                return null;
        // TODO           throw new UnderflowException();
        return array[1];
    }
    ...
    public AnyType deleteMin() {
        if (isEmpty())
            return null; //TODO throw new UnderflowException();
...
//    }
    ...
    public static void main(String[] args) {
        // Add code here to use the class
    }
}
